...
logo_path = os.path.join(BASE_DIR, "UI_Image", "0001.png")
...
titl = tk.Label(
    window, text="Attendance Management System", bg="#1c1c1c", fg="yellow", font=("Verdana", 27, "bold"),
)
...
ri_path = os.path.join(BASE_DIR, "UI_Image", "register.png")
...
ai_path = os.path.join(BASE_DIR, "UI_Image", "attendance.png")
...
vi_path = os.path.join(BASE_DIR, "UI_Image", "verifyy.png")
